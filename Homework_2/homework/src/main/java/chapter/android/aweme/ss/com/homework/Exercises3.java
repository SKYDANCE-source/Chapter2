 ...
 */
public class Exercises3 extends AppCompatActivity implements mAdapter.ListItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter adapter = new mAdapter(messages.size(),this);
    ...
    public void onListItemClick(int clickedItemIndex) {
        Intent intent = new Intent(this, ItemNum.class);
        intent.putExtra("itemNum",clickedItemIndex + 1);
